...
import utils
from data_aug import build_dataloaders, build_data_aug
import torch
...
parser.add_argument('--n_tests', default=5, type = int, help='number of tests in valid set')
...
if __name__ == '__main__':
    ...
    train_fns, val_fns, train_lbs, val_lbs = train_info
    ...
    for epoch in range(args.num_epochs):
        ...
        if (epoch + 1) % args.check_after == 0:
            ...
            if acc1 >= best_acc:
                ...
                saved_model_fn = saved_models + args.net_type + '_' + str(args.depth) + '_' + strftime('%m%d_%H%M') + '_r' + str(args.random_state)
